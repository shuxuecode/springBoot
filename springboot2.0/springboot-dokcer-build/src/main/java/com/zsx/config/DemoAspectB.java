...
@Aspect
@Component
@ConditionalOnProperty(prefix = "demo", name = "service", havingValue = "bbb")
public class DemoAspectB {

    @Pointcut("execution(* com.zsx.service.impl.DemoServiceImplb.*(..))")
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        DemoService demoService = SpringBeanUtils.getBean("demoService", DemoService.class);
